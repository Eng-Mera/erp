...
<?php echo Html::a('Print Invoice', ['print','id' => $model->id], ['class' => 'btn btn-lg btn-success pull-right' , 'target' => '_blank']) ;?>


<div id="printableDiv" class="table table-responsive table-bordered" style="line-height: 15px">
